...
pkgdatadir = $(datadir)/xeyes
pkgincludedir = $(includedir)/xeyes
pkglibdir = $(libdir)/xeyes
pkglibexecdir = $(libexecdir)/xeyes
...
am_4eyes_OBJECTS = Eyes.$(OBJEXT) transform.$(OBJEXT) 4eyes.$(OBJEXT)
4eyes_OBJECTS = $(am_4eyes_OBJECTS)
am__DEPENDENCIES_1 =
4eyes_DEPENDENCIES = $(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1)
...
am__v_CCLD_1 = 
SOURCES = $(4eyes_SOURCES)
DIST_SOURCES = $(4eyes_SOURCES)
...
ACLOCAL = ${SHELL} /tau/src/4eyes/missing --run aclocal-1.11
ADMIN_MAN_DIR = $(mandir)/man$(ADMIN_MAN_SUFFIX)
ADMIN_MAN_SUFFIX = 8
AMTAR = ${SHELL} /tau/src/4eyes/missing --run tar
AM_DEFAULT_VERBOSITY = 0
APP_MAN_DIR = $(mandir)/man$(APP_MAN_SUFFIX)
APP_MAN_SUFFIX = 1
AUTOCONF = ${SHELL} /tau/src/4eyes/missing --run autoconf
AUTOHEADER = ${SHELL} /tau/src/4eyes/missing --run autoheader
AUTOMAKE = ${SHELL} /tau/src/4eyes/missing --run automake-1.11
AWK = gawk
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /tau/src/4eyes/missing --run makeinfo
...
VERSION = 1.1.1
XEYES_CFLAGS = 
XEYES_LIBS = -lXext -lXmu -lXt -lX11
XORG_MAN_PAGE = X Version 11
XRENDER_CFLAGS = 
XRENDER_LIBS = -lXrender -lX11
abs_builddir = /tau/src/4eyes
abs_srcdir = /tau/src/4eyes
abs_top_builddir = /tau/src/4eyes
abs_top_srcdir = /tau/src/4eyes
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /tau/src/4eyes/install-sh
...
4eyes$(EXEEXT): $(4eyes_OBJECTS) $(4eyes_DEPENDENCIES) $(EXTRA_4eyes_DEPENDENCIES) 
	@rm -f 4eyes$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(4eyes_OBJECTS) $(4eyes_LDADD) $(LIBS)
...
#	$(AM_V_CC)source='$<' object='$@' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC@am__nodep@)$(COMPILE) -c -o $@ `$(CYGPATH_W) '$<'`
...
.PHONY: CTAGS GTAGS TAGS all all-am am--refresh check check-am clean \
	...
	tags tags-am uninstall uninstall-am uninstall-appmanDATA \
	uninstall-binPROGRAMS
