...
#define NUMPUPILSX	2
#define NUMPUPILSY	2
//#define NUMPUPILSX	$(numpupils x)
//#define NUMPUPILSY	$(numpupils y)
// TODO !! numpupils ....... shell $(input)
#define NUMBEROFPUPILS  (NUMPUPILSX * NUMPUPILSY)
	 TPoint		pupil[NUMBEROFPUPILS];	/* pupil pos */
         Boolean        pupilocked[NUMBEROFPUPILS];
